	...
	<div style="direction: rtl">
	 <table width="100%" cellpadding="0" cellspacing="0">
            <tr>
            	...
            	<td>کد  اتوبوس</td>
            	<td>
            		<input  id="txtBusCode" type="text" class="text searchControl " style="direction:ltr;width: 80px"  />
            	</td>
            	<td>
            ...
            <tr>
            	<td>اتاریخ</td>
            	<td>
            		<input  id="txtDate" type="text" class="text searchControl" style="direction:ltr;width: 80px"  />
            	</td>
            	<td>
					ساعت
				</td>
            	<td>
            		از<input  id="txtFromHour" type="text" class="text searchControl" style="direction:ltr;width: 40px"  />
            		تا<input  id="txtToHour" type="text" class="text searchControl" style="direction:ltr;width: 40px"/>
            	</td>
            	<td>
