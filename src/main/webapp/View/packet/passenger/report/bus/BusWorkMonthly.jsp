...
<head>
    ...
    <script type="text/javascript">
	    var restUrl="<c:url value = '/rest/packet/passenger/report/bus' />";
	    $(function(){
	    ...
	    function search() {
	        JsonData = { busCode:$('#txtBusCode').val(), 
						 year:$('#txtYear').val(),
						 month:$('#txtMonth').val(),
	...
	<div style="direction: rtl">
	 <table width="100%" cellpadding="0" cellspacing="0">
            <tr>
            	...
            	<td>کد خط</td>
            	<td>
            		<input  id="txtBusCode" type="text" class="text searchControl " style="direction:ltr" size="40" />
            	</td>
            	<td>
