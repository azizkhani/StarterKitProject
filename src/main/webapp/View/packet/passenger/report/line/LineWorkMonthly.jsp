	...
	<div style="direction: rtl">
	 <table width="100%" cellpadding="0" cellspacing="0">
            <tr>
            	...
            	<td>کد خط</td>
            	<td>
            		<input  id="txtLineCode" type="text" class="text searchControl " style="direction:ltr;width: 80px"  />
            	</td>
            	<td>
            ...
            <tr>
            	<td>سال</td>
            	<td>
            		<input  id="txtYear" type="text" class="text searchControl" style="direction:ltr;width: 80px" />
            	</td>
            	<td>
            		ماه
				</td>
