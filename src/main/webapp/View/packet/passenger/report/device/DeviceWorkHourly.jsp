    ...
    <script type="text/javascript">
	    ...
	    function search() {
	        JsonData = { lineCode:$('#txtLineCode').val(), 
						 ...
						 fromHoure:$('#txtFromHoure').val(),
						 toHoure:$('#txttoHoure').val(),
	...
	<div style="direction: rtl">
	 <table width="100%" cellpadding="0" cellspacing="0">
            ...
            <tr>
            	...
            	<td>
            		از<input  id="txtFromHoure" type="text" class="text searchControl" style="direction:ltr" size="40" />
            		تا<input  id="txtToHoure" type="text" class="text searchControl" style="direction:ltr" size="40" />
            	</td>
            	<td>
