...
<head>
    ...
    <script type="text/javascript">
	    ...
	    function search() {
	        ...
	        $.getJSON(restUrl+"/workDaily", JsonData, function (entities) {
	...
	<div style="direction: rtl">
	 <table width="100%" cellpadding="0" cellspacing="0">
            ...
            <tr>
            	<td>تاریخ</td>
            	<td>
            		از<input  id="txtFromDate" type="text" class="text searchControl" style="direction:ltr" size="40" />
            		
            	</td>
            	<td>تاریخ
				</td>
            	<td>
            	تا<input  id="txtToDate" type="text" class="text searchControl" style="direction:ltr" size="40" />
            	</td>
            	<td>
