...
<head>
    ...
    <script type="text/javascript">
	    var restUrl="<c:url value = '/rest/packet/passenger/report/driver' />";
	    $(function(){
	    	JsonData = { searchFilter: "", order: "", pageNumber: 0, pageSize: 0 };
            fillCombo("cmbLocation"	, 	"<c:url value = '/rest/location/list' />", JsonData, "id", "name",".....");
            $('#txtYear').datepicker({dateFormat: 'yy/mm/dd',showButtonPanel: true});
            $('#txtMonth').datepicker({dateFormat: 'yy/mm/dd',showButtonPanel: true});
		});
	    function search() {
	        JsonData = { driverCode:$('#txtDriverCode').val(), 
						 year:$('#txtYear').val(),
						 month:$('#txtMonth').val(),
						 locationId:$('#cmbLocation').val(), 
						 order: "", pageNumber: 0, pageSize: 10 
						};
	        $.getJSON(restUrl+"/workMonthly", JsonData, function (entities) {
	...
	<div style="direction: rtl">
	 <table width="100%" cellpadding="0" cellspacing="0">
            <tr>
            	...
            	<td>کد راننده</td>
            	<td>
            		<input  id="txtDriverCode" type="text" class="text searchControl " style="direction:ltr" size="40" />
            	</td>
            	<td>
            ...
            <tr>
            	<td>سال</td>
            	<td>
            		<input  id="txtYear" type="text" class="text searchControl" style="direction:ltr" size="40" />
            	</td>
            	<td>
            		ماه
				</td>
            	...
            	<td>
            	     <select id="txtMonth" class="searchControl">
            			<option value="">.....</option>
