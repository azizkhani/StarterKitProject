...
<head>
    ...
    <script type="text/javascript">
	    ...
	    function search() {
	        ...
	        $.getJSON(restUrl+"/workHourly", JsonData, function (entities) {
	...
	<div style="direction: rtl">
	 <table width="100%" cellpadding="0" cellspacing="0">
            ...
            <tr>
            	<td>تاریخ</td>
            	<td>
            		<input  id="txtDate" type="text" class="text searchControl" style="direction:ltr" size="40" />
            	</td>
            <td>
					ساعت
				</td>
            	<td>
            		از<input  id="txtFromHour" type="text" class="text searchControl" style="direction:ltr" size="40" />
            		تا<input  id="txtToHour" type="text" class="text searchControl" style="direction:ltr" size="40" />
            	</td>
            	<td>
