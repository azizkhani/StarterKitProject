  		...
  		<script type="text/javascript">
            ...
            jQuery(document).ready(function() {
                chart = new Highcharts.Chart({
                    ...
                    title: {
                        text: jQuery.browser.mozilla?'گزارش  کارکرد کل ماهانه':'گزارش  کارکرد کل ماهانه'
                    },
                    subtitle: {
                        text: ''
                    },
                    ...
                    plotOptions: {
                        ...
                        series: [{"name":1391,"data":[1832702000,2733360500,2293126000,814141000,0,0,0,0,0,0,0,0]}]
                });
