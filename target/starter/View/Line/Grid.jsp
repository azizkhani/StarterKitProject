...
<div class="table_content" id="table_content" style="width:100%">
 <%@ include file="Search.jsp" %>
                        ...
                        <thead>
                            <tr class="grid_header">
                                <th nowrap="nowrap">
                                 ...
                                 <th nowrap="nowrap">
                                   <spring:message code="UI.Line.Code" /><a class="orderLink" href="javascript:{orderAsc('e.code')}"> &#8595;</a><a
                                        class="orderLink" href="javascript:{orderDesc('e.code')}"> &#8593;</a>
                                </th>
                                <th nowrap="nowrap">
                                   <spring:message code="UI.Line.Name" /><a class="orderLink" href="javascript:{orderAsc('e.name')}"> &#8595;</a><a
                                        class="orderLink" href="javascript:{orderDesc('e.name')}"> &#8593;</a>
                                </th>
                                <th nowrap="nowrap">
                                    <spring:message code="UI.Line.Responsible" /><a class="orderLink" href="javascript:{orderAsc('e.responsible.id')}"> &#8595;</a><a
                                        class="orderLink" href="javascript:{orderDesc('e.responsible.id')}"> &#8593;</a>
                                </th>
                                <th nowrap="nowrap">
                                    <spring:message code="UI.Line.Terminal" /><a class="orderLink" href="javascript:{orderAsc('e.terminal.id')}"> &#8595;</a><a
                                        class="orderLink" href="javascript:{orderDesc('e.terminal.id')}"> &#8593;</a>
                                </th>
                                <th nowrap="nowrap">
                                   <spring:message code="UI.Line.TotalTimeGo" /><a class="orderLink" href="javascript:{orderAsc('e.totalTimeGo')}"> &#8595;</a><a
                                        class="orderLink" href="javascript:{orderDesc('e.totalTimeGo')}"> &#8593;</a>
                                </th>
                                <th nowrap="nowrap">
                                 <spring:message code="UI.Line.TotalTimeBack" /><a class="orderLink" href="javascript:{orderAsc('e.totalTimeBack')}"> &#8595;</a><a
                                        class="orderLink" href="javascript:{orderDesc('e.totalTimeBack')}"> &#8593;</a>
                                </th>
                            </tr>
                        </thead>
                        <tbody id="entityBody">
    ...
    <tr id="pattern${id}"  class="oddRow"
        ...
        <td align="right">
            <span >${totalTimeGo}</span>
        </td>
         <td align="right">
            <span >${totalTimeBack}</span>
        </td>
