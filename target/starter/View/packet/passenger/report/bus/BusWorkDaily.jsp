	...
	<div style="direction: rtl">
	 <table width="100%" cellpadding="0" cellspacing="0">
            ...
            <tr>
            	<td>از تاریخ</td>
            	<td>
            		<input  id="txtFromDate" type="text" class="text searchControl" style="direction:ltr;width: 80px"  />
            	</td>
            	<td>تا تاریخ
				</td>
            	<td>
            	<input  id="txtToDate" type="text" class="text searchControl" style="direction:ltr;width: 80px"  />
            	</td>
            	<td>
