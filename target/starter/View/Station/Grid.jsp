            ...
            <tr>
                <td align="center">
                    <table cellspacing="0" cellpadding="0" width="100%">
                        <tr>
                            <td>
                                <table width="170px" cellpadding="2" style="float: right">
                                   <tr>
                                        <td>
                        ...
                        <thead>
                            <tr class="grid_header">
                                <th nowrap="nowrap">
                                 ...
                                 <th nowrap="nowrap">
                                   <spring:message code="UI.Station.Code" /><a class="orderLink" href="javascript:{orderAsc('e.code')}"> &#8595;</a><a
                                        class="orderLink" href="javascript:{orderDesc('e.code')}"> &#8593;</a>
                                </th>
                                <th nowrap="nowrap">
                                   <spring:message code="UI.Station.Name" /><a class="orderLink" href="javascript:{orderAsc('e.name')}"> &#8595;</a><a
