                ...
                <td align="center">
                            <table cellpadding="2px" width="100%">
                                <tr>
                                    ...
                                    <td> <input type="button" value=" <spring:message code="UI.General.Search"  />" onclick="search()" class="actionBtn" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="fieldTitle" align="left">
                                    ...
                                    <td> <input type="button" value=" <spring:message code="UI.General.Clear"  />" onclick="clearFilter();search()" class="actionBtn" />&nbsp;
                                    </td>
                                </tr>
                            </table>
                </td>
